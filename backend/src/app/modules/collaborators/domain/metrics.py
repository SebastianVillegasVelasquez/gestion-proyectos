"""Reglas puras de cálculo de actividad de un colaborador.

Se aíslan aquí (sin SQLAlchemy ni FastAPI) para poder testearlas como
comportamiento, sin base de datos, y reutilizarlas desde cualquier capa.
"""
