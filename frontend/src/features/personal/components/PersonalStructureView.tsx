...
function TaskLeaf({ task, cbs }: { task: ApiMyTask; cbs: LeafCbs }) {
  ...
  return (
    <div className="relative mb-1.5 before:absolute before:left-[-16px] before:top-[20px] before:h-[1.5px] before:w-4 before:bg-border before:content-['']">
      <div className="group flex flex-wrap items-center gap-2.5 rounded-lg border border-l-[3px] border-border/40 border-l-brand-gold/70 bg-brand-gold/[0.06] py-2 pl-2 pr-3 shadow-sm transition-colors hover:bg-brand-gold/[0.12]">
